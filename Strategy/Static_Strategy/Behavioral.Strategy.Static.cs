...
namespace DesignPatterns
{
  ...
  // a.k.a. policy
  public class TextProcessor<LS> where LS : IListStrategy, new() // LS is an IListStrategy with new constructor
  {
  ...
  { 
    static void Main(string[] args)
    {
      ...
      WriteLine(tp2);
       ...
       / / DI Container cb.Register<MarkdownListStrategy>().As<IListStrategy>() // how it's done in the real world
    }
  }
}