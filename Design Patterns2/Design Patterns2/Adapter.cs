...
namespace Design_Patterns2
{
    ...
    public class LineToPointAdapter : IEnumerable<Point>// No longer Collection<Point>
    {
        private static int count;
        static Dictionary<int, List<Point>> cache
        = new Dictionary<int, List<Point>>();

        public LineToPointAdapter(Line line)    //AdapterInterface
        {
    ...
    class Adapter_Demo
    {
        ...
        public static void DrawPoint(Point p) //Rastor interface
        {
            Write(".");
        }
        ...
        {
            Draw();
            Draw(); //Adapter generates temporary information that caching resolves
